...
import { Trophy, TrendingUp, Users, Medal, Activity, Calendar, List } from 'lucide-react';
...
const mockTeamRankings: TeamRanking[] = [
    {
        ...
        currentStreak: 12,
        activeDays: 18,
        last14Days: [true, true, false, true, true, true, true, false, true, true, true, true, true, true]
    },
    {
        id: 2,
        name: "Бегуны Города",
        ...
        currentStreak: 8,
        activeDays: 15,
        last14Days: [true, false, true, true, true, false, true, true, true, true, false, true, true, true]
    },
    {
        id: 3,
        name: "Велосипедисты",
        ...
        currentStreak: 5,
        activeDays: 12,
        last14Days: [false, true, true, false, true, true, true, false, false, true, true, true, true, true]
    }
];
...
export const TeamTracker: React.FC<TeamTrackerProps> = ({ 
    ...
    const getTeamColor = (rank: number) => {
        ...
        if (rank === 2) return 'bg-slate-400 border-slate-500';
        if (rank === 3) return 'bg-amber-600 border-amber-700';
